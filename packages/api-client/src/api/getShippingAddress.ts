...
export async function getShippingAddress(context: Context): Promise<any> {
  console.log('getShippingAddress: Fetching shipping address...');

  const url = new URL(
    '/wp-json/vsf-wc-api/v1/address/shipping',
