...
import type { Category, Productcategory } from '@vue-storefront/woocommerce-api/';
...
export const getRootCategories = (productCategories: Productcategory): AgnosticCategoryTree => {
