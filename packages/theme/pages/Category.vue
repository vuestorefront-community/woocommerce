        ...
        <div class="products" v-if="!loading">
          ...
          >
            <SfProductCard
              ...
              :link="localePath(`/p/${productGetters.getId(product)}/${productGetters.getSku(product)}`)"
...
import { useCart, useWishlist, productGetters, useFacet, facetGetters } from '@vue-storefront/woocommerce';
