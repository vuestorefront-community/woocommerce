  ...
  <div id="product">
    <div class="product">
      <LazyHydrate when-idle>
        <SfGallery :images="productGallery" :key="productGallery.length" class="product__gallery" />
      </LazyHydrate>
      ...
      <div class="product__info">
        ...
        <div class="product__price-and-rating">
          <SfPrice
            ...
            :special="productGetters.getPrice(product).special"
          />
          <div>
        ...
        <LazyHydrate when-idle>
          <SfTabs :open-tab="1" class="product__tabs">
            <SfTab title="Description">
              <SfProperty
                name="Product Code"
                :value="productGetters.getId(product)"
...
export default {
  ...
  setup(props, context) {
    ...
    const categories = computed(() => productGetters.getCategories(product.value));
